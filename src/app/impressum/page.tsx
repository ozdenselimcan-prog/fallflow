  ...
  return (
    <>
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-12 sm:px-6">
        ...
        <p className="mt-3 rounded-xl bg-warning-soft px-4 py-3 text-sm text-warning">Platzhalter: Bitte tragen Sie vor dem Livebetrieb Ihre tatsächlichen Angaben ein.</p>
